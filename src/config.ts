...
const DEV_API_URL = Platform.select({
  // For iOS simulator
  ios: 'http://172.17.10.158:3000',
  // For Android emulator
  android: 'http://172.17.10.158:3000',
  // Fallback for physical devices - replace with your machine's IP address
  default: 'http://172.17.10.158:3000',
});

// Production API URL
const PROD_API_URL = 'https://ymed.ai';

export const API_URL = process.env.EXPO_PUBLIC_API_URL || DEV_API_URL;

// API Endpoints
export const API_ENDPOINTS = {
  login: '/api/auth/mobile/login',  // Mobile-specific login endpoint
